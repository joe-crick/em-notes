...
* Dependencies
  ...
  - Client-side routing: [pushy](https://github.com/clj-commons/pushy)
...
* [`src/em_notes/styles.cljs`](src/em_notes/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/em_notes/`](src/em_notes/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/em_notes/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `em-notes` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/em_notes/config.cljs) defaults to `true` in
...
```clj
(ns em-notes.example
  (:require [em-notes.config :as config])
